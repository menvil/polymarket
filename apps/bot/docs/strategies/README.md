...
|-----------|-------------|-----|-------|-----------------|--------|
| **AdaptiveEntry** (auto UP/DOWN) | **+25.39** | 79.4% | 101 | 3/4 дня | **Лучшая** |
...
- +25.39 USDC на 338 рынках, 79.4% WR
- 3/4 дней прибыльные (btc1: +1.94, btc2: +13.71, btc4: +1.14, btc5: +8.60)
...
**Ключевые результаты (15-мин)**:
- +13.75 USDC на 338 рынках, 69.1% WR
