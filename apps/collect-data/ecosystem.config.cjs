 ...
 *   Сервис держит глобальное состояние (подписки WS, открытые файлы ротатора,
 *   in-flight enrichment). Cluster-режим породил бы N копий, которые подписались
 *   бы на одни и те же рынки и писали бы в одни и те же файлы.
 */
module.exports = {
  apps: [
    {
