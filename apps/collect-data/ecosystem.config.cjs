  ...
  apps: [
    {
      ...
      // подметается startup cleanup. Тридцати секунд хватает с тройным
      // запасом над бюджетом приложения, и SIGKILL снова означает ровно то,
      // что должен: процесс не отвечает.
      kill_timeout: 30000,
      wait_ready: false,
