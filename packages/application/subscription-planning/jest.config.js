export default {
  ...
  moduleNameMapper: {
    ...
    '^@polymarket/policy$':        '<rootDir>/../policy/src/index.ts',
    // только для приёмочного теста контура (devDependency)
    '^@polymarket/market-discovery$': '<rootDir>/../market-discovery/src/index.ts',
  },
  transform: {
