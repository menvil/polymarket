...
- [x] Обновить PriceService для использования utilities ✅
  - Удалено ~297 строк дублированных методов
  - Фактическое сокращение: 787 → 490 строк (-37%)
- [x] Обновить QuantityService для использования utilities ✅
  - Удалено ~297 строк дублированных методов
  - Фактическое сокращение: 677 → 380 строк (-44%)
