...
```typescript
import { SignedQuantityService, SignedQuantity, InvalidSignedQuantityError } from '@polymarket/value-objects/signed-quantity';
import { Ok, Result } from '@polymarket/result';
