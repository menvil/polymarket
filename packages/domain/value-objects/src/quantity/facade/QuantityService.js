...
export class QuantityService {
    static SERVICE_NAME = 'QuantityService';
    /**
    ...
    static create(value) {
        ...
        return wrapOp(QuantityService.SERVICE_NAME, 'create', {
     ...
     * @returns Result<Quantity, InvalidQuantityError>
     */
    static createFromDecimal(decimal) {
        return wrapOp(QuantityService.SERVICE_NAME, 'create', { value: decimal.toString() }, () => Ok(Quantity.of(decimal)), InvalidQuantityError);
    }
    /**
     ...
     * ```
     */
    static multiply(quantity, factor) {
        ...
        if (isErr(factorResult)) {
            return Err(rewrap(QuantityService.SERVICE_NAME, 'multiply', {
     ...
     * ```
     */
    static divide(quantity, divisor) {
        ...
        if (isErr(divisorResult)) {
            return Err(rewrap(QuantityService.SERVICE_NAME, 'divide', {
                quantity: quantity.value().toString(),
     ...
     * ```
     */
    static roundToStep(quantity, stepSize, roundingMode = Decimal.ROUND_HALF_UP) {
        ...
        if (isErr(stepSizeResult)) {
            return Err(rewrap(QuantityService.SERVICE_NAME, 'roundToStep', {
                quantity: quantity.value().toString(),
     ...
     * ```
     */
    static increaseBy(quantity, delta, stepSize, options) {
        ...
        if (isErr(stepSizeResult)) {
            return Err(rewrap(QuantityService.SERVICE_NAME, 'increaseBy', {
                quantity: quantity.value().toString(),
...
//# sourceMappingURL=QuantityService.js.map