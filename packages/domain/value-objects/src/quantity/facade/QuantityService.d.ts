...
export declare class QuantityService {
     ...
     * ```
     */
    static multiply(quantity: Quantity, factor: number | string | Decimal): Result<Quantity, InvalidQuantityError>;
    /**
     ...
     * ```
     */
    static divide(quantity: Quantity, divisor: number | string | Decimal): Result<Quantity, InvalidQuantityError>;
    /**
     ...
     * ```
     */
    static roundToStep(quantity: Quantity, stepSize: number | string | Decimal, roundingMode?: Decimal.Rounding): Result<Quantity, InvalidQuantityError>;
    /**
     ...
     * ```
     */
    static portion(quantity: Quantity, rate: Ratio): Result<Quantity, InvalidQuantityError>;
    /**
     ...
     * ```
     */
    static increaseBy(quantity: Quantity, delta: Ratio, stepSize: number | string | Decimal, options?: {
