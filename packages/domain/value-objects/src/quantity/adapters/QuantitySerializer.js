...
export class QuantitySerializer {
    static SERVICE_NAME = 'QuantitySerializer';
    /**
    ...
    static fromJSON(json) {
        ...
        if (typeof json !== 'object' || json === null) {
            return Err(new InvalidQuantityError((ctx) => `Expected object, got ${ctx.type}`, {
                context: {
        ...
        if (Array.isArray(json)) {
            return Err(new InvalidQuantityError(() => `Expected object, got array`, {
                context: {
                    source: ErrorSource.PARSING,
                    service: QuantitySerializer.SERVICE_NAME,
                    op: 'fromJSON',
        ...
        if (!('value' in json)) {
            return Err(new InvalidQuantityError(() => `Missing required field 'value'`, {
                context: {
                    source: ErrorSource.PARSING,
                    service: QuantitySerializer.SERVICE_NAME,
                    op: 'fromJSON',
        ...
        if (typeof value !== 'string') {
            return Err(new InvalidQuantityError((ctx) => `Field 'value' must be string, got ${ctx.type}`, {
                context: {
                    source: ErrorSource.PARSING,
                    service: QuantitySerializer.SERVICE_NAME,
                    op: 'fromJSON',
...
//# sourceMappingURL=QuantitySerializer.js.map