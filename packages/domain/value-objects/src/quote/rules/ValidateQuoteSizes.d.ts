 ...
 * ```
 */
export declare class ValidateQuoteSizes {
    /**
     ...
     * ```
     */
    static check(bid: Price | null, bidSize: Quantity, ask: Price | null, askSize: Quantity): Result<void, InvalidQuoteError>;
}
//# sourceMappingURL=ValidateQuoteSizes.d.ts.map