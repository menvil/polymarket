 ...
 * ```
 */
export declare class ValidateMarketCrossing {
    /**
     ...
     * ```
     */
    static check(quoteBid: Price | null, quoteAsk: Price | null, orderbookBid: Price | null, orderbookAsk: Price | null): Result<void, InvalidQuoteError>;
    /**
     ...
     * ```
     */
    static checkQuote(quote: Quote, orderbookBid: Price | null, orderbookAsk: Price | null): Result<void, InvalidQuoteError>;
    /**
     ...
     * ```
     */
    static crossesMarket(quote: Quote, orderbookBid: Price | null, orderbookAsk: Price | null): boolean;
}
//# sourceMappingURL=ValidateMarketCrossing.d.ts.map