...
export class ValidateBidAsk {
     ...
     */
    static check(bid, ask) {
        if (bid.value().greaterThan(ask.value())) {
            return Err(new InvalidSpreadError((ctx) => `Invalid bid-ask: bid ${ctx.bid} cannot be greater than ask ${ctx.ask}`, {
                context: {
...
//# sourceMappingURL=ValidateBidAsk.js.map