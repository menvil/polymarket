 ...
 * ```
 */
export declare class ValidateAligned {
    /**
     ...
     * ```
     */
    static check(price: Price, tickSize: Decimal): Result<void, InvalidPriceError | InvalidTickSizeError>;
}
//# sourceMappingURL=ValidateAligned.d.ts.map