...
export class ValidateAligned {
    ...
    static check(price, tickSize) {
        ...
        if (!quotient.isInteger()) {
            return Err(new InvalidPriceError((ctx) => `Price ${ctx.price} is not aligned to tick size ${ctx.tickSize}`, {
                context: {
...
//# sourceMappingURL=ValidateAligned.js.map