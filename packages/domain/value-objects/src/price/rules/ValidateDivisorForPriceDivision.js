...
export class ValidateDivisorForPriceDivision {
    static check(divisor) {
        ...
        if (divisor.isNaN()) {
            return Err(new InvalidDivisorError(() => `Divisor cannot be NaN`, {
                context: {
        ...
        if (!divisor.isFinite()) {
            return Err(new InvalidDivisorError(() => `Divisor must be finite`, {
                context: {
                    source: ErrorSource.RULE_VALIDATION,
                    divisor: divisor.toString(),
                    reason: 'not_finite'
        ...
        if (divisor.isNegative()) {
            return Err(new InvalidDivisorError(() => `Divisor cannot be negative`, {
                context: {
                    source: ErrorSource.RULE_VALIDATION,
                    divisor: divisor.toString(),
                    reason: 'is_negative'
        ...
        if (divisor.isZero()) {
            return Err(new InvalidDivisorError(() => `Divisor cannot be zero`, {
                context: {
                    source: ErrorSource.RULE_VALIDATION,
                    divisor: divisor.toString(),
                    reason: 'is_zero'
...
//# sourceMappingURL=ValidateDivisorForPriceDivision.js.map