...
export declare class PriceFormatter {
     ...
     * ```
     */
    static toPercentage(price: Price, decimals?: number): Result<string, InvalidPriceError>;
    /**
     ...
     * ```
     */
    static toFixed(price: Price, decimals?: number): Result<string, InvalidPriceError>;
}
