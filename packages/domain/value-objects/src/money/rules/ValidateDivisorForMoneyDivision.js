...
export class ValidateDivisorForMoneyDivision {
    static check(divisor) {
        ...
        if (divisor.isNaN()) {
            return Err(new InvalidMoneyError('Divisor cannot be NaN', {
                context: {
        ...
        if (!divisor.isFinite()) {
            return Err(new InvalidMoneyError('Divisor must be finite', {
                context: {
                    source: ErrorSource.RULE_VALIDATION,
                    divisor: divisor.toString(),
        ...
        if (divisor.isZero()) {
            return Err(new InvalidMoneyError('Cannot divide by zero', {
                context: {
                    source: ErrorSource.RULE_VALIDATION,
                    divisor: divisor.toString(),
...
//# sourceMappingURL=ValidateDivisorForMoneyDivision.js.map