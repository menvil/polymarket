...
export class MoneySerializer {
    static SERVICE_NAME = 'MoneySerializer';
    /**
    ...
    static fromJSON(json) {
        ...
        if (typeof json !== 'object' || json === null || Array.isArray(json)) {
            ...
            return Err(new InvalidMoneyError(`Expected object, got ${displayedType}`, {
                context: {
        ...
        if (!('amount' in obj)) {
            return Err(new InvalidMoneyError(`Missing required field 'amount'`, {
                context: {
                    source: ErrorSource.PARSING,
                    service: MoneySerializer.SERVICE_NAME,
                    op: 'fromJSON',
        ...
        if (!('currency' in obj)) {
            return Err(new InvalidMoneyError(`Missing required field 'currency'`, {
                context: {
                    source: ErrorSource.PARSING,
                    service: MoneySerializer.SERVICE_NAME,
                    op: 'fromJSON',
        ...
        if (typeof amount !== 'number' && typeof amount !== 'string') {
            return Err(new InvalidMoneyError(`Field 'amount' must be number or string`, {
                context: {
                    source: ErrorSource.PARSING,
                    service: MoneySerializer.SERVICE_NAME,
                    op: 'fromJSON',
        ...
        if (typeof currency !== 'string') {
            return Err(new InvalidMoneyError(`Field 'currency' must be string`, {
                context: {
                    source: ErrorSource.PARSING,
                    service: MoneySerializer.SERVICE_NAME,
                    op: 'fromJSON',
        ...
        return MoneyService.create(amount, currency);
    }
    /**
...
//# sourceMappingURL=MoneySerializer.js.map