...
export declare class MoneyFormatter {
     ...
     * ```
     */
    static toFixed(money: Money, decimals?: number): Result<string, InvalidMoneyError>;
    /**
     ...
     * ```
     */
    static toCurrency(money: Money, showCurrency?: boolean, decimals?: number): Result<string, InvalidMoneyError>;
    /**
     ...
     * ```
     */
    static toCompact(money: Money, decimals?: number): Result<string, InvalidMoneyError>;
}
//# sourceMappingURL=MoneyFormatter.d.ts.map