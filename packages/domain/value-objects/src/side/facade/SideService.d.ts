 ...
 */
export declare class SideService {
    /**
     ...
     */
    private static parseSideOrThrow;
    /**
     ...
     * ```
     */
    static fromUnknown(value: unknown): Result<Side, InvalidSideError>;
    /**
     ...
     * ```
     */
    static isValid(value: unknown): value is Side;
    /**
     ...
     * ```
     */
    static equals(a: Side, b: Side): boolean;
    /**
     ...
     * ```
     */
    static getAllValues(): readonly Side[];
}
//# sourceMappingURL=SideService.d.ts.map