 ...
 * ```
 */
export var SideErrorReason;
(function (SideErrorReason) {
    /**
     ...
     */
    SideErrorReason["INVALID_VALUE"] = "INVALID_VALUE";
    /**
     ...
     */
    SideErrorReason["INVALID_TYPE"] = "INVALID_TYPE";
})(SideErrorReason || (SideErrorReason = {}));
//# sourceMappingURL=SideErrorReason.js.map