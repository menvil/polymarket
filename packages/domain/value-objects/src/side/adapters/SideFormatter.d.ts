 ...
 */
export declare class SideFormatter {
    /**
     ...
     * ```
     */
    static toDisplay(side: Side): string;
    /**
     ...
     * ```
     */
    static toUpperCase(side: Side): string;
    /**
     ...
     * ```
     */
    static toLowerCase(side: Side): Lowercase<Side>;
    /**
     ...
     * ```
     */
    static toEmoji(side: Side): string;
    /**
     ...
     * ```
     */
    static toColor(side: Side): 'green' | 'red';
    /**
     ...
     * ```
     */
    static toHexColor(side: Side): string;
    /**
     ...
     * ```
     */
    static toLogString(side: Side): string;
    /**
     ...
     * ```
     */
    static withSize(side: Side, size: number): string;
}
//# sourceMappingURL=SideFormatter.d.ts.map