 ...
 * ```
 */
export declare class OutcomeTokenService {
    /**
     ...
     * ```
     */
    static create(conditionRef: ConditionRef, outcomeKey: OutcomeKey): Result<OutcomeToken, InvalidOutcomeTokenError>;
    /**
...
//# sourceMappingURL=OutcomeTokenService.d.ts.map