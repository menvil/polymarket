 ...
 */
type OutcomeTokenAssetId = Extract<AssetId, {
    type: 'OUTCOME_TOKEN';
}>;
/**
 ...
 * ```
 */
export declare class OutcomeToken {
     ...
     */
    private static fromCanonicalAssetId;
    /**
     ...
     * ```
     */
    static fromAssetId(assetId: AssetId): OutcomeToken;
    /**
     ...
     * ```
     */
    static of(conditionRef: OnChainConditionRef, outcomeKey: OutcomeKey): OutcomeToken;
    /**
...
export {};
//# sourceMappingURL=OutcomeToken.d.ts.map