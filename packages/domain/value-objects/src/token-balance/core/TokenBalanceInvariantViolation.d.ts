 ...
 * ```
 */
export declare class TokenBalanceInvariantViolation extends Error {
    readonly reason?: TokenBalanceErrorReason | undefined;
    constructor(message: string, reason?: TokenBalanceErrorReason | undefined);
}
//# sourceMappingURL=TokenBalanceInvariantViolation.d.ts.map