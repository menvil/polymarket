...
export class ValidateTokenMatch {
    static check(token1, token2) {
        // Проверка: токены должны совпадать
        if (!token1.equals(token2)) {
            return Err(new InvalidTokenBalanceError((ctx) => `Token mismatch: ${ctx.token1OutcomeKey} vs ${ctx.token2OutcomeKey}`, {
                context: {
...
//# sourceMappingURL=ValidateTokenMatch.js.map