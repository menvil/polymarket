...
export class SignedQuantity {
     ...
     */
    static ZERO = SignedQuantity.of(new Decimal(0));
    static ONE = SignedQuantity.of(new Decimal(1));
    static MINUS_ONE = SignedQuantity.of(new Decimal(-1));
    /**
    ...
    constructor(_value) {
        ...
        // Инвариант 1: Not NaN
        if (_value.isNaN()) {
            throw new SignedQuantityInvariantViolation('SignedQuantity cannot be NaN', SignedQuantityErrorReason.NAN);
        }
        // Инвариант 2: Must be finite
        if (!_value.isFinite()) {
            throw new SignedQuantityInvariantViolation('SignedQuantity must be finite', SignedQuantityErrorReason.NON_FINITE);
        }
...
//# sourceMappingURL=SignedQuantity.js.map