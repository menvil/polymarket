 ...
 * ```
 */
export declare class SignedQuantityInvariantViolation extends Error {
    readonly reason: SignedQuantityErrorReason.NAN | SignedQuantityErrorReason.NON_FINITE;
    constructor(message: string, reason: SignedQuantityErrorReason.NAN | SignedQuantityErrorReason.NON_FINITE);
}
//# sourceMappingURL=SignedQuantityInvariantViolation.d.ts.map