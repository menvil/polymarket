...
export class AssetQuantity {
    ...
    constructor(asset, amount) {
        ...
        if (isFrozen) {
            ...
            if (asset.type === 'CURRENCY') {
                ...
                canonicalAsset = Object.freeze({ ...asset });
            }
     ...
     * ```
     */
    static fromAssetId(asset, amount) {
     ...
     * ```
     */
    static outcomeToken(conditionRef, outcomeKey, amount) {
...
//# sourceMappingURL=AssetQuantity.js.map