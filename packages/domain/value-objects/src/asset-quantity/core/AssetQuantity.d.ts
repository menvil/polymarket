 ...
 * ```
 */
export declare class AssetQuantity {
     ...
     * ```
     */
    constructor(asset: AssetId, amount: Quantity);
    /**
     * Создаёт AssetQuantity из AssetId с defensive copy
     *
     * @param asset - Asset identifier (может быть из ненадёжного источника)
     ...
     * ```
     */
    static fromAssetId(asset: AssetId, amount: Quantity): AssetQuantity;
    /**
     ...
     * ```
     */
    static usdc(amount: Quantity): AssetQuantity;
    /**
     ...
     * ```
     */
    static outcomeToken(conditionRef: OnChainConditionRef, outcomeKey: OutcomeKey, amount: Quantity): AssetQuantity;
    /**
...
//# sourceMappingURL=AssetQuantity.d.ts.map