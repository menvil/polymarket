...
export class AssetQuantityFormatter {
   ...
   * ```
   */
  public static toString(assetQty: AssetQuantity): string {
   ...
   * ```
   */
  public static toDisplayString(assetQty: AssetQuantity): string {
    const amount = assetQty.amount().value().toString();
   ...
   * ```
   */
  public static toShortString(assetQty: AssetQuantity): string {
    const amount = assetQty.amount().value().toString();
    const asset = assetQty.asset();
   ...
   * ```
   */
  public static toVerboseString(assetQty: AssetQuantity): string {
    const amount = assetQty.amount().value().toString();
    const asset = assetQty.asset();
