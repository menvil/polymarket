...
export class AssetQuantitySerializer {
    ...
    static fromJSON(json, source = ErrorSource.PARSING) {
        ...
        if (typeof json !== 'object' || json === null) {
            return Err(new InvalidAssetQuantityError((ctx) => `Expected object, got ${ctx.type}`, {
                context: {
                    source,
        ...
        if (Array.isArray(json)) {
            return Err(new InvalidAssetQuantityError(() => 'Expected object, got array', {
                context: {
                    source,
                    service: 'AssetQuantitySerializer',
                    op: 'fromJSON',
        ...
        if (!('asset' in obj)) {
            return Err(new InvalidAssetQuantityError(() => "Missing required field 'asset'", {
                context: {
                    source,
                    service: 'AssetQuantitySerializer',
                    op: 'fromJSON',
        ...
        if (!('amount' in obj)) {
            return Err(new InvalidAssetQuantityError(() => "Missing required field 'amount'", {
                context: {
                    source,
                    service: 'AssetQuantitySerializer',
                    op: 'fromJSON',
        ...
        if (typeof assetValue !== 'string') {
            return Err(new InvalidAssetQuantityError((ctx) => `Field 'asset' must be string, got ${ctx.type}`, {
                context: {
                    source,
                    service: 'AssetQuantitySerializer',
                    op: 'fromJSON',
        ...
        if (!assetId) {
            return Err(new InvalidAssetQuantityError((ctx) => `Failed to parse asset: '${ctx.asset}'`, {
                context: {
                    source,
                    service: 'AssetQuantitySerializer',
                    op: 'fromJSON',
        ...
        if (typeof amountValue !== 'string') {
            return Err(new InvalidAssetQuantityError((ctx) => `Field 'amount' must be string, got ${ctx.type}`, {
                context: {
                    source,
                    service: 'AssetQuantitySerializer',
                    op: 'fromJSON',
        ...
        try {
            ...
            return Err(new InvalidAssetQuantityError((ctx) => `Failed to parse amount as Decimal: ${ctx.error}`, {
                context: {
                    source,
                    service: 'AssetQuantitySerializer',
                    op: 'fromJSON',
        ...
        try {
            ...
            return Err(new InvalidAssetQuantityError((ctx) => `Failed to create Quantity: ${ctx.error}`, {
                context: {
                    source,
                    service: 'AssetQuantitySerializer',
                    op: 'fromJSON',
...
//# sourceMappingURL=AssetQuantitySerializer.js.map