...
export declare class AssetQuantityService {
     ...
     * ```
     */
    static create(asset: AssetId, amount: Quantity): Result<AssetQuantity, InvalidAssetQuantityError>;
    /**
     ...
     * ```
     */
    static createUsdc(amountValue: number | string | Decimal): Result<AssetQuantity, InvalidAssetQuantityError>;
    /**
     ...
     * ```
     */
    static createOutcomeToken(conditionRef: OnChainConditionRef, outcomeKey: OutcomeKey, amountValue: number | string | Decimal): Result<AssetQuantity, InvalidAssetQuantityError>;
    /**
     ...
     * ```
     */
    static isZero(assetQty: AssetQuantity): boolean;
    /**
     ...
     * ```
     */
    static isPositive(assetQty: AssetQuantity): boolean;
    /**
     ...
     * ```
     */
    static portion(assetQty: AssetQuantity, rate: Ratio): Result<AssetQuantity, InvalidAssetQuantityError>;
}
//# sourceMappingURL=AssetQuantityService.d.ts.map