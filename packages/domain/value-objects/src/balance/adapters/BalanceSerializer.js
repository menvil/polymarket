...
export class BalanceSerializer {
    static SERVICE_NAME = 'BalanceSerializer';
    /**
    ...
    static fromJSON(json) {
        ...
        if (typeof json !== 'object' || json === null || Array.isArray(json)) {
            ...
            return Err(new InvalidBalanceError(`Expected object, got ${typeDesc}`, {
                context: {
        ...
        if (!('available' in obj)) {
            return Err(new InvalidBalanceError(`Missing required field 'available'`, {
                context: {
                    source: ErrorSource.PARSING,
                    service: BalanceSerializer.SERVICE_NAME,
                    op: 'fromJSON',
        ...
        if (!('reserved' in obj)) {
            return Err(new InvalidBalanceError(`Missing required field 'reserved'`, {
                context: {
                    source: ErrorSource.PARSING,
                    service: BalanceSerializer.SERVICE_NAME,
                    op: 'fromJSON',
        ...
        if (typeof obj.available !== 'object' ||
            obj.available === null ||
            Array.isArray(obj.available)) {
            return Err(new InvalidBalanceError(`Field 'available' must be an object`, {
                context: {
                    source: ErrorSource.PARSING,
                    service: BalanceSerializer.SERVICE_NAME,
                    op: 'fromJSON',
        ...
        if (typeof obj.reserved !== 'object' ||
            obj.reserved === null ||
            Array.isArray(obj.reserved)) {
            return Err(new InvalidBalanceError(`Field 'reserved' must be an object`, {
                context: {
                    source: ErrorSource.PARSING,
                    service: BalanceSerializer.SERVICE_NAME,
                    op: 'fromJSON',
        ...
        if (!availableResult.ok) {
            ...
            const errorContext = availableResult.error;
            ...
            return Err(new InvalidBalanceError(`Failed to deserialize 'available': ${availableResult.error.message}`, {
                context: {
                    source: ErrorSource.PARSING,
                    service: BalanceSerializer.SERVICE_NAME,
                    op: 'fromJSON',
        ...
        if (!reservedResult.ok) {
            // Пробрасываем reason из ошибки Money, если он есть
            const errorContext = reservedResult.error;
            const moneyReason = errorContext.context?.reason;
            const balanceReason = moneyReason === 'UNSUPPORTED_CURRENCY'
                ? BalanceErrorReason.UNSUPPORTED_CURRENCY
                : BalanceErrorReason.INVALID_FORMAT;
            return Err(new InvalidBalanceError(`Failed to deserialize 'reserved': ${reservedResult.error.message}`, {
                context: {
                    source: ErrorSource.PARSING,
                    service: BalanceSerializer.SERVICE_NAME,
                    op: 'fromJSON',
        ...
        if (!('accountId' in obj)) {
            return Err(new InvalidBalanceError(`Missing required field 'accountId'`, {
                context: {
                    source: ErrorSource.PARSING,
                    service: BalanceSerializer.SERVICE_NAME,
                    op: 'fromJSON',
        ...
        if (!('venueId' in obj)) {
            return Err(new InvalidBalanceError(`Missing required field 'venueId'`, {
                context: {
                    source: ErrorSource.PARSING,
                    service: BalanceSerializer.SERVICE_NAME,
                    op: 'fromJSON',
        ...
        if (typeof obj.accountId !== 'string') {
            return Err(new InvalidBalanceError(`Field 'accountId' must be a string`, {
                context: {
                    source: ErrorSource.PARSING,
                    service: BalanceSerializer.SERVICE_NAME,
                    op: 'fromJSON',
        ...
        if (typeof obj.venueId !== 'string') {
            return Err(new InvalidBalanceError(`Field 'venueId' must be a string`, {
                context: {
                    source: ErrorSource.PARSING,
                    service: BalanceSerializer.SERVICE_NAME,
                    op: 'fromJSON',
        ...
        if (!accountId) {
            return Err(new InvalidBalanceError(`Invalid accountId format: ${obj.accountId}`, {
                context: {
                    source: ErrorSource.PARSING,
                    service: BalanceSerializer.SERVICE_NAME,
                    op: 'fromJSON',
        ...
        if (!venueId) {
            return Err(new InvalidBalanceError(`Field 'venueId' has invalid format. Must be uppercase letters, digits, underscores, 1-32 chars, not starting with digit`, {
                context: {
                    source: ErrorSource.PARSING,
                    service: BalanceSerializer.SERVICE_NAME,
                    op: 'fromJSON',
        ...
        return BalanceService.create(availableResult.value, reservedResult.value, accountId, venueId);
    }
    /**
...
//# sourceMappingURL=BalanceSerializer.js.map