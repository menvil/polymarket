...
export class BalanceFormatter {
    ...
    static toSummary(balance, decimals = 2, includeAccount = false, includeVenue = false) {
        if (decimals < 0 || !Number.isInteger(decimals)) {
            return Err(new InvalidBalanceError('decimals argument must be a non-negative integer', {
                context: {
        ...
        if (!availableResult.ok) {
            return Err(new InvalidBalanceError('Failed to format available amount', {
                context: {
        ...
        if (!reservedResult.ok) {
            return Err(new InvalidBalanceError('Failed to format reserved amount', {
                context: {
                    source: ErrorSource.SERVICE_CALL,
                    service: 'BalanceFormatter',
                    op: 'toSummary',
        ...
        if (!totalResult.ok) {
            return Err(new InvalidBalanceError('Failed to format total amount', {
                context: {
                    source: ErrorSource.SERVICE_CALL,
                    service: 'BalanceFormatter',
                    op: 'toSummary',
     ...
     * ```
     */
    static toAvailableString(balance, showCurrency = true, decimals = 2) {
        if (decimals < 0 || !Number.isInteger(decimals)) {
            return Err(new InvalidBalanceError('decimals argument must be a non-negative integer', {
                context: {
                    source: ErrorSource.RULE_VALIDATION,
     ...
     * ```
     */
    static toReservedString(balance, showCurrency = true, decimals = 2) {
        if (decimals < 0 || !Number.isInteger(decimals)) {
            return Err(new InvalidBalanceError('decimals argument must be a non-negative integer', {
                context: {
                    source: ErrorSource.RULE_VALIDATION,
     ...
     * ```
     */
    static toTotalString(balance, showCurrency = true, decimals = 2) {
        if (decimals < 0 || !Number.isInteger(decimals)) {
            return Err(new InvalidBalanceError('decimals argument must be a non-negative integer', {
                context: {
                    source: ErrorSource.RULE_VALIDATION,
...
//# sourceMappingURL=BalanceFormatter.js.map