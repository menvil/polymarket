...
export class RatioService {
    static SERVICE_NAME = 'RatioService';
    /**
     ...
     * ```
     */
    static fromDecimal(value, options) {
     ...
     * ```
     */
    static fromPercent(percent, options) {
...
//# sourceMappingURL=RatioService.js.map