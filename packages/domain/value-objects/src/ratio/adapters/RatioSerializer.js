...
export class RatioSerializer {
    ...
    static fromJSON(json) {
        ...
        if (typeof json !== 'object' || json === null) {
            return Err(new InvalidRatioError('Invalid JSON: expected object', {
                context: {
        ...
        if (typeof obj.ratio !== 'string') {
            ...
            return Err(new InvalidRatioError('Invalid JSON: "ratio" field must be string', {
                context: {
                    source: ErrorSource.PARSING,
                    op: 'fromJSON',
...
//# sourceMappingURL=RatioSerializer.js.map