 ...
 * ```
 */
export declare class TimestampInvariantViolation extends Error {
    readonly reason: TimestampErrorReason;
    constructor(message: string, reason: TimestampErrorReason);
}
//# sourceMappingURL=TimestampInvariantViolation.d.ts.map