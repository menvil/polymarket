...
export class TimestampFormatter {
     ...
     * ```
     */
    static toRelative(timestamp, now = Timestamp.now()) {
...
//# sourceMappingURL=TimestampFormatter.js.map