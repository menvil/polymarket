...
export class TimestampService {
    static SERVICE_NAME = 'TimestampService';
    /**
    ...
    static create(value) {
        ...
        return wrapOp(TimestampService.SERVICE_NAME, 'create', { raw: { field: 'value', value: String(value) } }, () => {
    ...
    static fromISO(iso) {
        ...
        return wrapOp(TimestampService.SERVICE_NAME, 'fromISO', ctx, () => {
    ...
    static addMs(timestamp, delta) {
        ...
        if (isErr(deltaResult)) {
            return Err(rewrap(TimestampService.SERVICE_NAME, 'addMs', {
        ...
        return wrapOp(TimestampService.SERVICE_NAME, 'addMs', ctx, () => {
