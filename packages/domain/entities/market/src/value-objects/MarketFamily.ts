/**
 * Семейство рынка: как рынок устроен структурно и какая спецификация к нему прилагается
 *
 * @see {@link MarketFamily}
 */
 ...
 * в течение жизни рынка (в отличие от `MarketState`, который отражает
