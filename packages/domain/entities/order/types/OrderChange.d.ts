 ...
 * ```
 */
export type OrderChange = OrderChangeAccepted | OrderChangeRejected | OrderChangeCancelled | OrderChangeExpired | OrderChangeFillApplied;
//# sourceMappingURL=OrderChange.d.ts.map