 ...
 * ```
 */
export declare function parsePortfolioId(raw: string): PortfolioId | undefined;
/**
 ...
 * ```
 */
export declare function asPortfolioId(raw: string): PortfolioId;
//# sourceMappingURL=PortfolioId.d.ts.map