...
export class Portfolio {
    ...
    static create(params) {
        if (!params.id) {
            return Err(new PortfolioValidationError('Portfolio ID is required', {
                context: { field: 'id' },
            }));
        }
        if (!params.accountId) {
            return Err(new PortfolioValidationError('Account ID is required', {
                context: { field: 'accountId', portfolioId: params.id },
            }));
        }
        if (!params.balance) {
            return Err(new PortfolioValidationError('Balance is required', {
