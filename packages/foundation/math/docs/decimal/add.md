...
Функция сохраняет математические свойства сложения:
...
**Важно:** Ассоциативность может нарушаться при ограниченной точности `Decimal.js`, так как каждая операция округляется согласно настроенной `precision`. При стандартных настройках (precision = 20) это свойство сохраняется для большинства практических случаев. Коммутативность и свойство нейтрального элемента гарантированы всегда.
