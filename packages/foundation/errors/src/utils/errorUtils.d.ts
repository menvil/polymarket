 ...
 */
export type AnyTradingError = InvalidPriceError | InvalidQuantityError | InvalidPercentageError | InvalidRatioError | InvalidAmountError | InvalidMoneyError | InvalidBalanceError | CurrencyMismatchError | InvalidAssetQuantityError | InvalidFeeError | InvalidSideError | InvalidSignedQuantityError | InvalidSpreadError | InvalidQuoteError | InvalidOutcomeTokenError | InvalidTimestampError | DivisionByZeroError | ArithmeticOverflowError | InvalidOperandError | InvalidRoundingModeError;
/**
 * Конструктор Domain Error
 */
export type ErrorConstructor<TError extends AnyTradingError> = new (message: string | ((context: Record<string, unknown>) => string), options?: {
    code?: string;
 ...
 * ```
 */
export declare function toCause(e: unknown): {
    name: string;
    message: string;
    stack?: string;
};
 ...
 * ```
 */
export declare function toDecimal<TError extends AnyTradingError>(field: string, input: number | string | Decimal, reasonEnum: string, ErrorConstructor: ErrorConstructor<TError>, options?: {
    nanReason?: string;
    nonFiniteReason?: string;
 ...
 */
export declare function expectedMathError<TError extends AnyTradingError>(e: Error, ErrorConstructor: ErrorConstructor<TError>): TError;
/**
 ...
 * Трассировка (service, op, opChain) добавляется через rewrap в wrapOp.
 */
export declare function unexpectedError<TError extends AnyTradingError>(e: unknown, ErrorConstructor: ErrorConstructor<TError>): TError;
/**
 ...
 * Трассировка (service, op, opChain) добавляется через rewrap в wrapOp.
 */
export declare function developerMisuseError<TError extends AnyTradingError>(e: Error, ErrorConstructor: ErrorConstructor<TError>): TError;
/**
 ...
 * Трассировка (service, op, opChain) добавляется через rewrap в wrapOp.
 */
export declare function coreInvariantError<TError extends AnyTradingError>(e: Error & {
    reason: string;
}, ErrorConstructor: ErrorConstructor<TError>): TError;
/**
 ...
 */
export declare function isExpectedMathError(e: unknown): e is Error;
/**
 ...
 * ```
 */
export declare function isCoreInvariantViolation(e: unknown): e is Error & {
    reason: string;
};
/**
 ...
 * ```
 */
export declare function rewrap<TError extends AnyTradingError>(serviceName: string, op: string, ctx: Record<string, unknown>, err: TError, ErrorConstructor: ErrorConstructor<TError>, systemCtx?: Record<string, unknown>): TError;
/**
 ...
 * ```
 */
export declare function wrapOp<T, TError extends AnyTradingError>(serviceName: string, op: string, ctx: Record<string, unknown>, fn: () => Result<T, TError>, ErrorConstructor: ErrorConstructor<TError>): Result<T, TError>;
/**
 ...
 * ```
 */
export declare function currencyMismatchError<TError extends AnyTradingError>(expected: string, actual: string, reasonEnum: string, ErrorConstructor: ErrorConstructor<TError>): TError;
