...
export class TradingError extends Error {
    ...
    constructor(message, options) {
        ...
        if (typeof message === 'function') {
            ...
            if (!options?.context) {
                throw new TypeError('TradingError: Message template function provided without context. ' +
            ...
            throw new TypeError(`TradingError: Message must be a string or function, got ${typeof message}`);
        }
        super(resolvedMessage);
        // Автоматически устанавливаем имя из класса
        this.name = this.constructor.name;
        this.timestamp = new Date();
        this.code = options?.code ?? this.constructor.code;
     ...
     * ```
     */
    safeSerializeContext(obj, seen = new WeakSet()) {
        ...
        if (Array.isArray(obj)) {
            const result = obj.map((item) => {
                if (item !== null && typeof item === 'object') {
                    return this.safeSerializeContext(item, seen);
                }
                return item;
            });
        ...
        for (const key in obj) {
            if (Object.prototype.hasOwnProperty.call(obj, key)) {
                ...
                if (value !== null && typeof value === 'object') {
                    result[key] = this.safeSerializeContext(value, seen);
                }
                else {
                    result[key] = value;
                }
...
//# sourceMappingURL=TradingError.js.map