 ...
 */
export declare class InvalidPercentageError extends TradingError {
    readonly severity: ErrorSeverity;
    /**
     * Рекомендуемый код ошибки
     */
    static readonly code = "INVALID_PERCENTAGE";
}
//# sourceMappingURL=InvalidPercentageError.d.ts.map