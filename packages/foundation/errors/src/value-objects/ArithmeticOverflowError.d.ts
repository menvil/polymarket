 ...
 */
export declare class ArithmeticOverflowError extends TradingError {
    readonly severity: ErrorSeverity;
    /**
     * Рекомендуемый код ошибки
     */
    static readonly code = "ARITHMETIC_OVERFLOW";
}
//# sourceMappingURL=ArithmeticOverflowError.d.ts.map