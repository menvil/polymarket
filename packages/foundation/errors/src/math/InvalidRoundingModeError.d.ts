 ...
 * ```
 */
export declare class InvalidRoundingModeError extends TradingError {
    readonly severity: ErrorSeverity;
    /**
     * Рекомендуемый код ошибки
     */
    static readonly code = "INVALID_ROUNDING_MODE";
}
//# sourceMappingURL=InvalidRoundingModeError.d.ts.map