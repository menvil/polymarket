 ...
 */
export declare class ResultChain<T, E> {
    /**
     * @internal
 ...
 * ```
 */
export declare const OkChain: <T>(value: T) => ResultChain<T, never>;
/**
 ...
 * ```
 */
export declare const ErrChain: <E>(error: E) => ResultChain<never, E>;
/**
 ...
 * ```
 */
export declare const toChain: <T, E>(result: Result<T, E>) => ResultChain<T, E>;
/**
...
export declare const R: {
    readonly ok: <T>(value: T) => ResultChain<T, never>;
    readonly err: <E>(error: E) => ResultChain<never, E>;
    readonly from: <T, E>(result: Result<T, E>) => ResultChain<T, E>;
};
export { fromPromise, fromNullable, fromThrowable } from './result.js';
//# sourceMappingURL=ResultChain.d.ts.map