 ...
 * ```
 */
export declare const combine: <T, E>(results: Array<Result<T, E>>) => Result<T[], E>;
/**
 ...
 * ```
 */
export declare const flatMapW: <T, U, E, F>(result: Result<T, E>, fn: (value: T) => Result<U, F>) => Result<U, E | F>;
/**
 ...
 * ```
 */
export declare const mapErrW: <T, E, F>(result: Result<T, E>, fn: (error: E) => F) => Result<T, F>;
/**
 ...
 * ```
 */
export declare const orElseW: <T, E, F>(result: Result<T, E>, fn: (error: E) => Result<T, F>) => Result<T, F>;
/**
 ...
 * ```
 */
export declare const tryCatch: <T, E>(fn: () => T, onError: (error: unknown) => E) => Result<T, E>;
/**
 ...
 * ```
 */
export declare const tryAsync: <T, E>(fn: () => Promise<T>, onError: (error: unknown) => E) => Promise<Result<T, E>>;
/**
 ...
 * ```
 */
export declare function fromPromise<T, E>(promise: Promise<T>, onError: (error: unknown) => E): Promise<Result<T, E>>;
/**
 ...
 * ```
 */
export declare function fromThrowable<Args extends readonly unknown[], T, E>(fn: (...args: Args) => T, onError: (error: unknown) => E): (...args: Args) => Result<T, E>;
