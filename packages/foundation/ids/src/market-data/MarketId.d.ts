 ...
 * ```
 */
export declare function asMarketId(raw: string): MarketId | undefined;
/**
 ...
 */
export declare function unsafeMarketId(raw: string): MarketId;
//# sourceMappingURL=MarketId.d.ts.map