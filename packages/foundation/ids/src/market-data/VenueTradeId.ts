 ...
 * ```
 */
export type VenueTradeId = string & { readonly __brand: 'VenueTradeId' };
 ...
 * ```
 */
export function asVenueTradeId(raw: string): VenueTradeId | undefined {
  return validateBrandedId(raw, MAX_VENUE_TRADE_ID_LENGTH) as VenueTradeId | undefined;
}
 ...
 */
/* c8 ignore next 3 */
export function unsafeVenueTradeId(raw: string): VenueTradeId {
  return raw as VenueTradeId;
}
