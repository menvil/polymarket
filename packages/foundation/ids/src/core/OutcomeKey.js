 ...
 * ```
 */
export function parseOutcomeKey(raw) {
 ...
 * ```
 */
export function outcomeKeyToIndex(key) {
    if (key === BinaryOutcome.DOWN)
        return 0;
 ...
 * ```
 */
export function indexToOutcomeKey(index) {
    if (index === 0)
        return BinaryOutcome.DOWN;
    if (index === 1)
        return BinaryOutcome.UP;
    return undefined;
}
/**
 ...
 * ```
 */
export function outcomeKeyEquals(a, b) {
    return a === b;
}
/**
 ...
 * ```
 */
export function oppositeOutcomeKey(key) {
    if (key === BinaryOutcome.UP)
        return BinaryOutcome.DOWN;
    if (key === BinaryOutcome.DOWN)
        return BinaryOutcome.UP;
...
//# sourceMappingURL=OutcomeKey.js.map