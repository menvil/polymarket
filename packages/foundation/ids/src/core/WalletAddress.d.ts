 ...
 * ```
 */
export declare function isValidWalletAddressFormat(address: string): boolean;
/**
 ...
 * ```
 */
export declare function parseWalletAddress(address: string): WalletAddress | undefined;
/**
 ...
 * ```
 */
export declare function walletAddressEquals(a: WalletAddress, b: WalletAddress): boolean;
/**
 ...
 * ```
 */
export declare function walletAddressToString(address: WalletAddress): string;
