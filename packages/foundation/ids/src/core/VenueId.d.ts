...
export type VenueId = string & {
    readonly __brand: 'VenueId';
};
/**
 * Известные venues
 */
export declare const KnownVenues: {
    readonly POLYMARKET: VenueId;
    readonly KALSHI: VenueId;
};
/**
 ...
 * ```
 */
export declare function isKnownVenue(id: string): id is VenueId;
/**
 ...
 * ```
 */
export declare function asVenueId(raw: string): VenueId | undefined;
//# sourceMappingURL=VenueId.d.ts.map