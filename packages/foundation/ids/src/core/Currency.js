 ...
 * ```
 */
export const SUPPORTED_CURRENCIES = ['USDC'];
/**
 ...
 * ```
 */
export const KnownCurrencies = Object.freeze(Object.fromEntries(SUPPORTED_CURRENCIES.map((c) => [c, c])));
/**
 ...
 * ```
 */
export function asSupportedCurrency(code) {
    if (typeof code !== 'string') {
        return undefined;
    }
