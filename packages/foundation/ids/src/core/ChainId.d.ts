 ...
 * Известные chain IDs
 */
export declare const KnownChainIds: {
    readonly ETHEREUM_MAINNET: ChainId;
 ...
 * ```
 */
export declare function isValidChainId(n: number): n is ChainId;
/**
 ...
 * ```
 */
export declare function chainId(n: number): ChainId | undefined;
/**
 ...
 * ```
 */
export declare function parseChainId(str: string): ChainId | undefined;
