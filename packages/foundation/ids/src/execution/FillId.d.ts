 ...
 * ```
 */
export declare function asFillId(raw: string): FillId | undefined;
/**
 ...
 */
export declare function unsafeFillId(raw: string): FillId;
//# sourceMappingURL=FillId.d.ts.map