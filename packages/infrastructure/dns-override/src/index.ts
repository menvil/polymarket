 ...
 * другой сетевой клиент. Раньше эти классы жили внутри legacy V1-адаптера
 * площадки, из-за чего сборщик — которому нужен ТОЛЬКО обход DNS — тянул за
 * собой весь legacy-стек и ломался вместе с ним. Адаптер удалён, пакет остался.
 *
